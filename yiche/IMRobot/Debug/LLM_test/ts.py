...
if __name__ == '__main__':
    ...
    parser.add_argument('--hf_model_location', type=str,default="./vicuna-13b-v1.5-16k", help="tokenizer model path")
    ...
    # head_lines =["You are a language retelling engineer.Please retell some interesting things, and the length must to be greater than 5000 words:"] * 1
    ...
    # head_lines = ["你是一个资深劳动合同拟定师，需要尽可能详细的拟定一份4520字的劳动合同，其中需要2000字的劳动仲裁法，2000多字的公司职工保护义务法。你现在可以开始写了:"]
